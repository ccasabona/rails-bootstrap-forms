...
module BootstrapForm
  class FormBuilder < ActionView::Helpers::FormBuilder
    ...
    BASIC_HELPERS = %w{file_field select collection_select grouped_collection_select
      time_zone_select check_box radio_button collection_check_boxes collection_radio_buttons fields_for}
    ...
    BASIC_HELPERS.each do |method_name|
